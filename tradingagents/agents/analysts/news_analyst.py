...
请特别注意：
⚠️ 核心新闻窗口为“分析日所在周的上一个周一”至分析日（含首尾）；窗口内新闻可纳入近期结论，但越接近分析日权重越高
⚠️ 核心窗口之外、分析日前30天内的新闻只能作为历史背景；超过30天或晚于分析日期的新闻不得纳入结论
⚠️ 如果核心窗口内没有新闻，必须明确写出“未获取到核心窗口有效新闻”，并将当前新闻信号评为中性；不得把历史背景描述为当前催化剂
✅ 优先分析最新的、高相关性的新闻事件
...
- 核心窗口内新闻可用于近期判断，但必须按发布时间衰减权重，越接近分析日权重越高。
- 核心窗口之外、分析日前30天内的新闻仅可作为历史背景，不得称为“最新消息”或当前催化剂。
- 发布时间超过30天或晚于分析日期的新闻不得纳入本次结论。
- 如果核心窗口内没有有效新闻，必须明确写出“未获取到核心窗口有效新闻”，当前新闻信号按中性处理，不得用旧闻填补。
...
本次分析基准日期是 {current_date}。核心新闻窗口为“分析日所在周的上一个周一”至分析日（含首尾），窗口内新闻可用于近期判断但应按发布时间衰减权重；窗口外、分析日前30天内新闻只能作为历史背景，超过30天或晚于分析日期的新闻必须排除。若核心窗口无有效新闻，明确说明并将当前新闻信号评为中性。
